    ...
    return (
        <div className="h-[30vh] shrink-0 flex flex-col items-center justify-center p-4 relative border-b-4 border-black bg-slate-950 transition-colors duration-300 overflow-hidden select-none">
            ...
            <div className="flex-[2] flex flex-col items-center justify-start z-10 w-full">
                ...
                <div className="mt-2 text-[9px] font-black text-slate-500 uppercase tracking-[0.4em] bg-slate-900/50 px-4 py-1.5 rounded-full border border-white/5 backdrop-blur-sm">
                    Bultos en Cola
                </div>
            </div>
        </div>
