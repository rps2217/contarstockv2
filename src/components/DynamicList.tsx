                    ...
                    <button 
                      ...
                      className={`py-3 px-4 rounded-xl flex items-center justify-between transition-all border shrink-0 ${
                        selectedIds.size === filteredItems.length && filteredItems.length > 0
                          ...
                          : (theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-white/5 border-white/10 text-stone-400 hover:text-white' : 'bg-stone-50 border-stone-200 text-stone-500 hover:text-stone-900')
                      }`}
                    >
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-t border-white/5 pt-4">
                ...
                <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                  ...
                  <button 
                    ...
                    className={`flex-1 sm:flex-initial flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl transition-all border text-xs font-bold uppercase tracking-wider ${
                      theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-white/5 border-white/10 text-stone-300 hover:bg-white/10' : 'bg-stone-100 border-stone-200 text-stone-600 hover:bg-stone-200'
                    }`}
                  >
