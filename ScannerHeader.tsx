...
export const ScannerHeader: React.FC<ScannerHeaderProps> = memo(({ erpOrder, scansPerMinute, showSpeedometer, onPause }) => {
 return (
 <header className="h-14 px-4 flex justify-between items-center z-20 shrink-0 bg-black/20 ">
 ...
 <button 
 onClick={onPause} 
 className="bg-white/10 hover:bg-red-500/80 text-white/80 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold uppercase tracking-wider flex items-center gap-2 transition-all "
 >
