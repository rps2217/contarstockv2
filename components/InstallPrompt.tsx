  ...
  if (showIOSPrompt) {
      ...
      return (
        <div className="fixed bottom-0 left-0 right-0 p-4 z-[100] animate-in slide-in-from-bottom-full duration-500 pointer-events-none">
            <div className="bg-slate-900/90 backdrop-blur text-white p-4 rounded-2xl shadow-2xl border border-slate-700 pointer-events-auto relative max-w-sm mx-auto">
