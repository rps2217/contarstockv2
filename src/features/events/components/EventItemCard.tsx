  ...
  return (
    <motion.div
      ...
      className={`border rounded-2xl flex flex-col md:grid md:grid-cols-[48px_minmax(0,2.5fr)_minmax(0,1.2fr)_minmax(0,1fr)_auto] items-start md:items-center gap-3 md:gap-4 group transition-all relative ${
        ...
        theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-brand-surface hover:bg-brand-surface/80 shadow-lg shadow-black/20' : 'bg-white shadow-md hover:shadow-lg'
      } ${
    ...
    >
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-2 md:hidden">
            ...
            <div className="shrink-0 flex items-center gap-1.5">
              {item.isAdjusted && (
                <span className={`text-[8px] font-black uppercase tracking-wider px-1.5 py-0.5 rounded-md ${
                  theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/35' : 'bg-emerald-100 text-emerald-800'
                }`}>
                  Ajustado
                </span>
              )}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className={`p-2 rounded-xl border ${
              ...
              <p className={`font-bold uppercase truncate ${
                ...
                theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-blue-400' : 'text-blue-600'
              }`}>
            ...
            <div className={`p-2 rounded-xl border ${
              ...
              <button
                ...
                className={`font-bold uppercase flex items-center gap-1 transition-all active:scale-95 ${
                  ...
                  theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-secondary' : 'text-slate-700'
                }`}
              >
                {item.barcode || 'N/A'}
          ...
          {(item.traspaso || item.observaciones) && (
            <div className="grid grid-cols-2 gap-2">
              {item.traspaso && (
                <div className={`p-2 rounded-xl border ${
                  theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-brand-dark border-white/5' : 'bg-slate-50 border-slate-150'
                }`}>
                  ...
                  <p className={`font-bold uppercase truncate text-xs ${
                    theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-indigo-400' : 'text-indigo-600'
                  }`}>
                    {item.traspaso}
                  </p>
                </div>
              ...
              {item.observaciones && (
                <div className={`p-2 rounded-xl border ${
                  ...
                  <p className={`font-bold uppercase truncate text-xs ${
                    theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-secondary' : 'text-slate-600'
                  }`}>
                    {item.observaciones}
                  </p>
                </div>
      ...
      <div className="hidden md:flex flex-col gap-1 min-w-0 overflow-hidden">
        ...
        {item.isAdjusted && (
          <span className={`text-[7px] font-black uppercase tracking-widest px-1.5 py-0.5 rounded-md inline-block w-fit mt-1 ${
            theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 'bg-emerald-100 text-emerald-700 border border-emerald-200'
          }`}>
            Ajustado
          </span>
        )}
      ...
      <div className="hidden md:flex flex-col gap-1.5 min-w-0 overflow-hidden">
        <div className="flex flex-col gap-1">
          ...
          {item.event && (
            <span className={`font-black uppercase tracking-widest px-1.5 py-0.5 rounded-md w-fit truncate ${
              ...
              theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-rose-500/20 text-rose-400' : 'bg-rose-100 text-rose-700'
            }`}>
              {item.event}
            </span>
          )}
        ...
        {item.frc ? (
          ...
          <div className={`px-2 py-1.5 rounded-xl border-2 border-dashed flex items-center justify-center w-fit ${
            theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'border-white/10 text-slate-600' : 'border-slate-200 text-muted'
          }`}>
      ...
      <div className="flex items-center justify-between w-full md:w-auto md:flex-col md:items-start gap-2 md:gap-0.5 min-w-0 overflow-hidden">
        ...
        >
          ...
          } ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-emerald-500/80' : 'text-emerald-600/80'}`} />
          <span className={`font-black uppercase tracking-widest truncate ${
            isExpanded ? 'text-sm' : 'text-xs'
          } ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-emerald-400' : 'text-emerald-600'}`}>
