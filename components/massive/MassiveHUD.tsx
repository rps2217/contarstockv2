...
export const MassiveHUD: React.FC<Props> = memo(({ item, feedback, onDecrement, onIncrement }) => {
 ...
 <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-black/50 border border-white/20 px-5 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] whitespace-nowrap shadow-xl">
