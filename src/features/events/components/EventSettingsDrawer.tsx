              ...
              <section className="space-y-4">
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-xl border flex items-center justify-between group transition-all ${
                    (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'border-amber-500/20 bg-amber-500/5 hover:bg-amber-500/10' : 'border-amber-200 bg-amber-50 hover:bg-amber-100'
                  }`}
                >
                ...
                <div 
                  ...
                  className={`p-4 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${
                    preferences.compactView
                      ...
                      : (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'border-white/5 bg-white/5 hover:bg-white/10' : 'border-slate-200 bg-slate-50 hover:bg-slate-100'
                  }`}
                >
                  <div>
                    <p className={`text-xs font-black uppercase tracking-tight ${
              ...
              <section className="pt-4 border-t border-white/5">
                <button
                  ...
                  className={`w-full p-4 rounded-xl border flex items-center gap-4 transition-all ${
                    (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'border-blue-500/20 bg-blue-500/5 hover:bg-blue-500/10' : 'border-blue-200 bg-blue-50 hover:bg-blue-100'
                  }`}
                >
