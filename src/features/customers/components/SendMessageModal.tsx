          ...
          <div className="p-6 space-y-4">
            <div className={`p-3 rounded-xl border flex items-center gap-3 ${
              ...
              <div className={`w-10 h-10 rounded-full flex items-center justify-center font-black ${
                theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-emerald-500/20 text-emerald-400' : 'bg-emerald-100 text-emerald-600'
              }`}>
                {(customer.firstName || '').charAt(0)}{(customer.lastName || '').charAt(0)}
              </div>
              <div>
                <p className={`text-sm font-bold ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-white' : 'text-slate-900'}`}>
                  {customer.firstName} {customer.lastName}
                </p>
                <p className={`text-xs font-mono ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-muted' : 'text-slate-500'}`}>
                  {customer.phone}
                </p>
              </div>
            </div>
