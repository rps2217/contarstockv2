...
export const EventPriorityPanel: React.FC<EventPriorityPanelProps> = ({ stats, theme, onSelectItem, onActionClick }) => {
  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        console.error('Error loading event panel layout', e);
      }
    }
  }, []);
  ...
  if (priorityItems.length === 0 && eventAlerts.length === 0) return null;
  ...
  return (
    <div className="mb-8 space-y-4">
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                { id: 'event-alerts', label: 'Alertas de Evento' },
      ...
      >
        {/* CARD 1: EVENTOS CRÍTICOS */}
        {!isHidden('critical-events') && (
          <motion.div 
            layout
            ...
            style={{ 
              width: cardSizes['critical-events']?.width || 'calc(66.66% - 0.5rem)',
              height: cardSizes['critical-events']?.height || 'auto',
              minWidth: '300px',
              flexGrow: cardSizes['critical-events']?.width === '100%' ? 1 : 0
            }}
          ...
          >
            <CardHeader 
              ...
              subtitle="Top Volumen Pendiente"
              icon={Activity}
            ...
            <div className={`flex-1 p-2 space-y-1 overflow-y-auto ${cardSizes['critical-events']?.height === '400px' ? 'max-h-[300px]' : ''}`}>
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className={`text-[9px] font-black px-1.5 py-0.5 rounded-md uppercase ${
                        theme === 'dark' ? 'bg-blue-500/10 text-blue-500' : 'bg-blue-50 text-blue-600'
                      }`}>
                        {item.event}
                      </span>
                ...
                {eventAlerts.map((alert) => (
                  <div key={alert.name} className="space-y-1">
                    <div className="flex items-center justify-between text-[10px] font-black uppercase">
                      ...
                      <span className="text-blue-500">{alert.count} ítems</span>
                    </div>
            ...
            >
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-[10px] font-bold text-slate-500 leading-relaxed">
                  <span className="text-blue-500 font-black">TIP:</span> Revisa las <span className="underline">Diferencias de Inventario</span> antes de realizar el cierre de turno.
                </p>
              </div>
            </motion.div>
          )}
