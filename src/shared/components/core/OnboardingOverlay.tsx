  ...
  const steps = [
    {
      ...
      description: "Tu nuevo centro de control logístico de alto rendimiento. Diseñado para ser rápido, confiable y profesional.",
      icon: <LayoutDashboard className="w-12 h-12 text-brand-warning" />,
      color: "amber"
    },
    {
      title: "Sincronización Inteligente",
      description: "Tus datos se guardan localmente y se sincronizan automáticamente con la nube cuando hay conexión.",
      icon: <Cloud className="w-12 h-12 text-blue-500" />,
      color: "blue"
    },
    {
      title: "Modo Hammer (Ráfaga)",
      description: "Escanea cientos de productos en segundos sin interrupciones. Ideal para inventarios masivos.",
      icon: <Zap className="w-12 h-12 text-rose-500" />,
      color: "rose"
    },
    {
      title: "Gestión de Clientes",
      description: "Notifica a tus clientes automáticamente cuando sus pedidos estén listos para retiro.",
        ...
        <div className="p-10 text-center">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              {step === steps.length - 1 ? <CheckCircle2 className="w-4 h-4" /> : <ArrowRight className="w-4 h-4" />}
            </button>
          </div>
        </div>
      </motion.div>
