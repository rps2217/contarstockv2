...
export const ReceptionItemCard = React.memo(
  ({ item, onDelete, onShowPhoto, onViewDetail, isCompact }: ReceptionItemCardProps) => {
          ...
          <div className="flex items-center gap-4 overflow-hidden flex-1">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <span
                  className={`font-mono text-base font-black truncate uppercase tracking-wider ${
              ...
              <div className="text-[10px] font-bold text-slate-500 uppercase mt-1.5 flex items-center gap-2 flex-wrap">
                ...
                <span className="w-1 h-1 bg-slate-600 rounded-full"></span>
                <span
                  className={`px-2 py-0.5 font-black rounded-md ${
