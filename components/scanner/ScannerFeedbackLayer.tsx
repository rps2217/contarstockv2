...
export const ScannerFeedbackLayer: React.FC<ScannerFeedbackLayerProps> = memo(({ feedback, isWindowFocused = true, isIdle = false }) => {
    ...
    if (!isWindowFocused) {
        return (
            <div className="absolute inset-0 z-[100] bg-slate-900/90 flex flex-col items-center justify-center text-center p-8 backdrop-blur-xl animate-in fade-in duration-300">
