...
import { ShieldAlert, AlertTriangle, Download, Clock, CheckCircle2, Trash2 } from 'lucide-react';
...
export const ExpiryCard: React.FC<Props> = ({ item, onVerify, onDelete, isVerified }) => {
  const statusConfig = {
  ...
  return (
    <div className={`flex flex-col md:flex-row md:items-center gap-4 p-4 rounded-2xl border ${config.border} bg-[#0f1219] hover:bg-[#151923] transition-colors`}>
