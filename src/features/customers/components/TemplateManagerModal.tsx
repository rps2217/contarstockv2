                ...
                <div 
                  ...
                  className={`p-3 rounded-xl border transition-all cursor-pointer ${
                    editingTemplate?.id === template.id
                      ? (theme === 'dark' ? 'bg-blue-500/10 border-blue-500/50' : 'bg-blue-50 border-blue-200')
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded-lg transition-colors shrink-0 ${
                        theme === 'dark' ? 'hover:bg-rose-500/20 text-rose-400' : 'hover:bg-rose-100 text-rose-500'
                      }`}
                    >
              ...
              <form onSubmit={handleSave} className="space-y-4">
                ...
                <div>
                  ...
                  <div className={`mt-2 p-3 rounded-xl border text-xs ${
                    theme === 'dark' ? 'bg-blue-500/10 border-blue-500/20 text-blue-200' : 'bg-blue-50 border-blue-100 text-blue-800'
                  }`}>
