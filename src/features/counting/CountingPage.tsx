...
export const CountingPage: React.FC = () => {
    ...
    // Fix: Added missing 'Navigate' import to fix 'Cannot find name Navigate' error.
    ...
    return (
        <div className="fixed inset-0 z-[100] flex flex-col bg-black text-white font-mono overflow-hidden select-none">
            ...
            <NumericKeypad isOpen={showKeypad} title="EAN / SKU MANUAL" onClose={() => setShowKeypad(false)} onConfirm={(v) => { actions.handleExternalScan(v, state.multiplier); setShowKeypad(false); }} />
