      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            >
              <Truck
                className={`w-5 h-5 ${(theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-brand-info' : 'text-indigo-600'}`}
              />
            </div>
            <div>
              <h2
                className={`text-lg font-black uppercase ${(theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-white' : 'text-slate-800'}`}
              >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            <div>
              ...
              {!initialData && (
                <p className="text-[10px] text-muted mt-1 flex items-center gap-1">
                  <Info className="w-3 h-3" /> El RUT es el identificador único y no se puede
                  cambiar después.
                </p>
              )}
            </div>
          ...
          >
            ...
            >
              <ShieldAlert
                className={`w-4 h-4 ${(theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-brand-info' : 'text-indigo-500'}`}
              />
            ...
            <label
              className={`flex items-center gap-3 cursor-pointer p-3 rounded-xl border transition-colors ${
                ...
                (theme as unknown) === 'appsheet-dark' ||
                (theme as unknown) === 'gray'
                  ? 'bg-brand-surface border-white/5 hover:border-brand-info'
            ...
            >
              <input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setFormData({ ...formData, hasExchange: e.target.checked })
                }
                className="w-5 h-5 text-brand-info rounded focus:ring-brand-info"
              />
              <div>
                <p
                  className={`text-sm font-bold ${(theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-white' : 'text-slate-800'}`}
                >
                  Acepta Canje / Devolución
                </p>
                <p className="text-[10px] font-medium text-slate-500">
                  Permite retornar productos por vencer
                </p>
              </div>
            </label>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setFormData({ ...formData, withdrawalDays: parseInt(e.target.value) || 0 })
                  }
                ...
                />
                <span
                  className={`text-sm font-bold ${(theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-muted' : 'text-slate-600'}`}
                >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                  setFormData({ ...formData, exchangePolicy: e.target.value })
                }
          ...
          <div className="pt-4 flex gap-3">
            <button
              ...
              className={`flex-1 px-4 py-3 font-bold rounded-xl transition-colors ${
                ...
                (theme as unknown) === 'appsheet-dark' ||
                (theme as unknown) === 'gray'
                  ? 'bg-brand-dark text-muted hover:bg-brand-dark/80'
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 font-bold rounded-xl transition-colors shadow-lg ${
                ...
                (theme as unknown) === 'appsheet-dark' ||
                (theme as unknown) === 'gray'
                  ? 'bg-brand-warning text-black hover:bg-brand-warning/90 shadow-brand-warning/10'
