      ...
      >
        <motion.div
          ...
          className={`w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] ${
            (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-surface border border-white/10' : 'bg-white border border-slate-200'
          }`}
        >
          {/* Header */}
          <div className={`p-6 border-b flex items-center justify-between shrink-0 ${
            ...
            <button 
              ...
              className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${
                (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-white/5 text-muted hover:bg-white/10 hover:text-white' : 'bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-900'
              }`}
            >
              <X className="w-6 h-6" />
            </button>
          ...
          <div className="flex-1 overflow-y-auto p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6 flex flex-col">
              ...
              <div className={`p-5 rounded-2xl border ${
                (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-white/5 border-white/10' : 'bg-slate-50 border-slate-200'
              }`}>
                {!isEditingTemplate ? (
                  <div className="flex gap-3">
                    {!selectedTemplateId.startsWith('default-') && (
                  ...
                  <div className="flex gap-3 items-center">
                    <input
                      ...
                      className={`flex-1 px-4 py-3 rounded-xl text-sm font-medium border outline-none ${
                        (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-black/40 border-white/10 text-white' : 'bg-white border-slate-200 text-slate-900'
                      }`}
                      autoFocus
                    />
                    <button
            ...
            <div className="flex flex-col h-full">
              ...
              <div className={`flex-1 rounded-3xl border overflow-hidden flex flex-col shadow-inner ${
                (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-white border-white/10' : 'bg-white border-slate-200'
              }`}>
          ...
          <div className={`p-6 border-t flex justify-end shrink-0 ${
            (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'border-white/10 bg-black/20' : 'border-slate-200 bg-slate-50'
          }`}>
            <button
