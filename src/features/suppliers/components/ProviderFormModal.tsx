    ...
    <div className="fixed inset-0 z-[200] bg-surface/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        <div className={`flex items-center justify-between p-6 border-b ${
          theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'border-white/5' : 'border-slate-100'
        }`}>
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
              theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-brand-info/10' : 'bg-indigo-100'
            }`}>
              <Truck className={`w-5 h-5 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-brand-info' : 'text-indigo-600'}`} />
            </div>
            <div>
              <h2 className={`text-lg font-black uppercase ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-white' : 'text-slate-800'}`}>
          ...
          <button onClick={onClose} className={`p-2 rounded-full transition-colors ${
            theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'hover:bg-white/10 text-muted' : 'hover:bg-slate-100 text-muted'
          }`}>
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className={`rounded-2xl p-5 border space-y-4 ${
            theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-brand-dark border-white/5' : 'bg-slate-50 border-slate-200'
          }`}>
            <h3 className={`text-sm font-black uppercase flex items-center gap-2 ${
              theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-white' : 'text-slate-700'
            }`}>
              <ShieldAlert className={`w-4 h-4 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-brand-info' : 'text-indigo-500'}`} />
              Política de Vencimientos
            </h3>

            <label className={`flex items-center gap-3 cursor-pointer p-3 rounded-xl border transition-colors ${
              theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-brand-surface border-white/5 hover:border-brand-info' : 'bg-white border-slate-200 hover:border-indigo-300'
            }`}>
              <input
                type="checkbox"
              ...
              />
              <div>
                <p className={`text-sm font-bold ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-white' : 'text-slate-800'}`}>Acepta Canje / Devolución</p>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <span className={`text-sm font-bold ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'text-muted' : 'text-slate-600'}`}>Días antes de la fecha de caducidad</span>
              </div>
            </div>
          ...
          <div className="pt-4 flex gap-3">
            <button
              ...
              className={`flex-1 px-4 py-3 font-bold rounded-xl transition-colors ${
                theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-brand-dark text-muted hover:bg-brand-dark/80' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
              }`}
            >
              Cancelar
            </button>
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 font-bold rounded-xl transition-colors shadow-lg ${
                theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' ? 'bg-brand-warning text-black hover:bg-brand-warning/90 shadow-brand-warning/10' : 'bg-indigo-600 text-white hover:bg-indigo-700 shadow-indigo-200'
              }`}
            >
