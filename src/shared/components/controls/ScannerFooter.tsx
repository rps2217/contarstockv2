...
export const ScannerFooter: React.FC<ScannerFooterProps> = ({ 
    ...
    return (
        <div className="h-24 shrink-0 bg-slate-950 border-t border-white/10 flex items-center px-4 gap-3 pb-safe-area shadow-[0_-10px_30px_rgba(0,0,0,0.5)] z-50 relative">
            ...
            {/* GATILLO ÓPTICO (Modo Momentáneo Industrial) */}
            <button 
            ...
            >
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.2em]">
                    {isTriggerActive ? 'LÁSER ACTIVO' : 'MANTENER'}
                </span>
            </button>
            ...
            <button 
                ...
                className="h-14 w-14 bg-slate-800 text-white rounded-2xl flex items-center justify-center active:bg-slate-700 transition-colors border border-white/5 hover:border-white/20"
            >
