...
export const BulkHistoryPanel: React.FC<BulkHistoryPanelProps> = ({
  ...
  const bgClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-surface' : 'bg-white';
  const textClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-white' : 'text-slate-900';
  const mutedClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-muted' : 'text-slate-500';

  if (history.length === 0) {
    return (
      <div className={`p-4 rounded-xl ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-elevated' : 'bg-slate-100'}`}>
  ...
  return (
    <div className={`rounded-xl overflow-hidden border ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-surface border-subtle' : 'bg-white border-slate-200'}`}>
      <div className={`p-3 flex items-center justify-between border-b ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'border-subtle' : 'border-slate-200'}`}>
        <div className="flex items-center gap-2">
          <Clock className={`w-4 h-4 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-blue-400' : 'text-blue-600'}`} />
          <span className={`text-sm font-bold ${textClass}`}>Historial de Acciones</span>
        </div>
        <button
          onClick={onClear}
          className={`text-xs font-bold uppercase tracking-wider ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-muted hover:text-white' : 'text-slate-500 hover:text-slate-900'}`}
        >
          Limpiar
        </button>
      </div>
      ...
      <div className="max-h-64 overflow-y-auto">
        {history.slice(0, 10).map(entry => (
          <div
            key={entry.id}
            className={`p-3 flex items-center justify-between border-b last:border-b-0 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'border-subtle' : 'border-slate-100'}`}
          >
...
export const DryRunModal: React.FC<DryRunModalProps> = ({
  ...
  const textClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-white' : 'text-slate-900';
  const mutedClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-muted' : 'text-slate-500';
  const inputBgClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-black/40 border-white/10' : 'bg-slate-50 border-slate-200';
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className={`relative w-full max-w-lg rounded-[2rem] shadow-2xl overflow-hidden border-4 border-blue-500 ${bgClass}`}>
        ...
        <div className="p-8 space-y-6">
          {/* Resumen */}
          <div className={`p-4 rounded-xl border ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-blue-900/20 border-blue-500/20' : 'bg-blue-50 border-blue-200'}`}>
            <div className="flex items-center justify-between">
              <span className={`text-sm font-bold ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-blue-400' : 'text-blue-600'}`}>
                Elementos afectados
              </span>
          ...
          <div className="space-y-2">
            ...
            <div className={`rounded-xl border ${inputBgClass} max-h-48 overflow-y-auto`}>
              {results.preview.slice(0, 10).map((item, idx) => (
                <div key={idx} className={`p-3 border-b last:border-b-0 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'border-white/5' : 'border-slate-200'}`}>
                  <div className="flex items-center justify-between">
...
export const ViewPreferencesToolbar: React.FC<ViewPreferencesToolbarProps> = ({
  ...
  const bgClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-elevated' : 'bg-white';
  const textClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-white' : 'text-slate-900';
  const mutedClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'text-muted' : 'text-slate-500';
  const activeClass = theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-100 text-blue-600';
  ...
  return (
    <div className={`flex items-center gap-2 p-2 rounded-xl ${bgClass}`}>
      ...
      {/* Separador */}
      <div className={`w-px h-6 ${theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-slate-700' : 'bg-slate-200'}`} />
      ...
      <div className="flex items-center gap-1">
        ...
        >
          {sortOptions.map(opt => (
            <option key={opt.value} value={opt.value} className={theme === 'dark' || theme === 'night' || theme === 'high-contrast' || theme === 'appsheet-dark' || theme === 'gray' ? 'bg-elevated' : 'bg-white'}>
              {opt.label}
            </option>
          ))}
        </select>
