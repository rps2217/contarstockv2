...
const INLINE_ICONS: Record<string, string> = {
  ...
  loader:
    '<path d="M12 2v4m0 12v4m-8-10h4m12 0h4m-4.93-6.07l-2.83 2.83m-5.66 5.66l-2.83 2.83m0-11.32l2.83 2.83m5.66 5.66l2.83 2.83"/>',
  'alert-circle':
    '<circle cx="12" cy="12" r="10"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01"/>',
  'alert-triangle':
    '<path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v4m0 4h.01"/>',
  checkcircle:
    '<path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 4L12 14.01l-3-3"/>',
  package:
    '<path d="M16.5 9.4l-9-5.19M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12"/>',
  scan: '<path d="M3 7V5a2 2 0 012-2h2M17 3h2a2 2 0 012 2v2M21 17v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2"/>',
  refresh:
    '<path d="M23 4v6h-6M1 20v-6h6"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/>',
  settings:
  ...
  'wifi-off':
    '<line x1="1" y1="1" x2="23" y2="23"/><path d="M16.72 11.06A10.94 10.94 0 0119 12.55M5 12.55a10.94 10.94 0 015.17-2.39M10.71 5.05A16 16 0 0122.58 9M1.42 9a15.91 15.91 0 014.7-2.88M8.53 16.11a6 6 0 016.95 0M12 20h.01"/>',
  ...
  barcode:
    '<path d="M3 5v14M21 5v14M5 5a1 1 0 100-2 1 1 0 000 2zM9 5a1 1 0 100-2 1 1 0 000 2zM15 5a1 1 0 100-2 1 1 0 000 2zM19 5a1 1 0 100-2 1 1 0 000 2z"/>',
...
// Mapa de nombres amigables para accesibilidad
...
interface IconProps {
  ...
  className?: string;
  strokeWidth?: number;
  /** Descripción del icono para accesibilidad (override automático) */
  ariaLabel?: string;
  /** Si es un icono decorativo (oculta de lectores de pantalla) */
  decorative?: boolean;
}

// Componente Icon principal - usa SVG inline para iconos del catálogo
export const Icon = memo(
  ({ name, size = 24, className, strokeWidth = 2, ariaLabel, decorative = false }: IconProps) => {
    ...
    return (
      <svg
        ...
        aria-label={decorative ? undefined : ariaLabel || ICON_LABELS[name]}
...
export const LazyIcon = memo(({ name, size = 24, className, fallback }: LazyIconProps) => {
