...
export const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const { formData, error, isSaving, isDuplicating, updateField, handleDuplicate, handleSave } =
    useProductForm({
      initialData,
      onSaveSuccess,
      onClose,
      ...
      <div className="px-8 pt-8 pb-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-muted uppercase tracking-wider mt-1">
      ...
      <form onSubmit={handleSave} className="px-8 pb-8 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <div className="absolute right-4 top-1/2 -translate-y-1/2">
                <span className="text-[8px] font-black bg-blue-100 text-blue-600 px-2 py-1 rounded-lg uppercase">
                  ID LOG
                </span>
              </div>
            </div>
        ...
        <div className="p-4 bg-indigo-50/50 dark:bg-indigo-900/10 rounded-2xl border border-indigo-100 dark:border-indigo-500/10 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5 flex flex-col justify-center pt-5">
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                >
                  <div
                    className={`absolute top-1 bottom-1 w-4 bg-white rounded-full transition-all ${
          ...
          <p className="text-[8px] font-medium text-indigo-400 dark:text-indigo-500/60 leading-tight italic px-1">
            * Al modificar estos valores, se actualizará la política general para TODOS los
        ...
        <div className="pt-2">
          <SettingsButton
            type="submit"
            label={
              isDuplicating ? 'Crear Duplicado' : initialData ? 'Guardar Cambios' : 'Crear Producto'
            }
