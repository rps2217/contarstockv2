...
export const ThemeSection: React.FC<Props> = ({ settings, updateSetting }) => {
    ...
    return (
        <section className="bg-transparent rounded-2xl p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {themes.map(t => (
                    <button 
                        ...
                        className={`p-4 rounded-xl border-2 flex flex-col items-center gap-2 transition-all relative ${settings.theme === t.id ? 'border-blue-500 ring-2 ring-blue-100/20' : 'border-black/5 dark:border-white/5'}`}
                    >
