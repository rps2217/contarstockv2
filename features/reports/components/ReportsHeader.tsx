  ...
  return (
    <div className="flex-none">
      ...
      <div className="grid grid-cols-2 gap-2 mb-4">
        ...
        <button
          onClick={onStartNew}
          className="bg-blue-600 text-white font-bold py-2.5 rounded-xl hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 shadow-md shadow-blue-200 active:scale-95"
        >
