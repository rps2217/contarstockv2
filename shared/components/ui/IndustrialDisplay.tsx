                ...
                <div className="flex-1 flex flex-col items-center justify-center p-2 text-center overflow-hidden relative">
                    ...
                    <div className="mt-3 flex items-center gap-3">
                        {targetQuantity !== undefined && targetQuantity > 0 ? (
                            <div className="bg-black/60 backdrop-blur-xl px-6 py-2 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] flex items-center gap-3 border-2 border-white/10 shadow-2xl">
