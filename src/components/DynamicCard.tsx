  ...
  return (
    <motion.div
      ...
      className={`p-4 border rounded-2xl flex flex-col gap-3 transition-all cursor-pointer relative overflow-hidden group ${
        isSelected 
          ? ((theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-indigo-500/20 border-indigo-500/50 ring-1 ring-indigo-500' : 'bg-indigo-50 border-indigo-300 ring-1 ring-indigo-400')
          : ((theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-white/5 border-white/5 hover:bg-white/10' : 'bg-white border-stone-200 shadow-sm hover:border-indigo-300')
        ...
        <div className="flex items-start gap-3 min-w-0">
          {onSelect && (
            <button 
              ...
              className={`mt-1 shrink-0 transition-colors ${isSelected ? 'text-indigo-500' : ((theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-slate-600 hover:text-muted' : 'text-stone-300 hover:text-stone-500')}`}
            >
            ...
            <div className="flex items-center gap-2">
              {barcodeField && item[barcodeField] && (
                <span className={`text-[10px] font-mono font-bold px-1.5 py-0.5 rounded uppercase tracking-widest border w-fit ${
                  (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'bg-elevated text-secondary border-white/10' : 'bg-stone-100 text-stone-600 border-stone-200'
                }`}>
                  {item[barcodeField]}
                </span>
              )}
          ...
          return (
            <div key={key} className="flex flex-col gap-0.5">
              ...
              <span className={`text-xs font-bold truncate ${
                (theme as unknown) === 'dark' || (theme as unknown) === 'night' || (theme as unknown) === 'high-contrast' || (theme as unknown) === 'appsheet-dark' || (theme as unknown) === 'gray' ? 'text-secondary' : 'text-stone-700'
              }`}>
                {col.type === 'image' ? (
