import{p as g}from"./PrinterEngine-CgOETYrX.js";import{h as d}from"./vendor-utils-cx5FaEdG.js";import{k as h}from"./index-BF9opSFj.js";import"./ThermalPrinterEngine-Czy6PZKZ.js";import"./JsBarcode-C5aMIrqV.js";import"./vendor-react-CPSFPLP-.js";import"./vendor-ui-DGZAR2Dc.js";import"./vendor-db-Bc1sp9FM.js";import"./vendor-ai-Dwzn4vLG.js";class l{static printTicket(r){g.printBrowserTicket(r)}}const C=o=>{const s=d(new Date,"MMMM yyyy",{locale:h}).toUpperCase(),a=o.length===0?"<div style='text-align:center; padding:20px; border:2px solid #000'>NO HAY REGISTROS</div>":o.map((t,i)=>`
        <div class="item">
...
`),t=new Blob([a],{type:"text/csv;charset=utf-8;"}),i=document.createElement("a"),e=URL.createObjectURL(t);i.setAttribute("href",e),i.setAttribute("download",`vencimientos_${d(new Date,"yyyyMMdd")}.csv`),i.style.visibility="hidden",document.body.appendChild(i),i.click(),document.body.removeChild(i)},N=o=>{const r=window.open("","_blank");if(!r)return;const a=d(new Date,"dd/MM/yyyy HH:mm"),i=`
  ...
  `;r.document.write(i),r.document.close()};export{M as handleExportExpirationsCSV,C as handlePrintExpirations,j as handlePrintLabels,$ as handlePrintSelectedEvents,N as handleSendEmail};
