...
import { ReceptionHero } from '../../components/reception/ReceptionHero'; // Legacy component, candidato a shared/
import { QueueManager } from '../../components/reception/QueueManager'; // Legacy component
...
export const ReceptionPage: React.FC = () => {
    ...
    // Color de fondo reactivo (Feedback Visual Global)
        ...
        <div className={`h-screen w-full flex flex-col font-mono select-none overflow-hidden text-white transition-colors duration-200 ${containerClass}`}>
            ...
            {showKeypad && (
                <NumericKeypad 
                    ...
                    onInput={(v) => actions.handleManualInput(v)} 
                    onDelete={() => {}} 
