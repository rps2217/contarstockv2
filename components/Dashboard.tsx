...
import { Database, ScanLine, Settings, ArrowRight, Box, Layers, Fingerprint } from 'lucide-react';
    ...
    <div className="w-full max-w-4xl mx-auto pb-24 px-4 md:px-0 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 gap-6 mb-8">
        ...
        <button 
            ...
            className="group relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-700 rounded-[2rem] shadow-lg shadow-blue-200 p-8 text-left transition-all hover:shadow-xl hover:scale-[1.01] flex flex-col justify-between h-48 md:h-56"
        >
            ...
            <div className="z-10 text-white">
                ...
                <p className="font-medium text-blue-100 text-sm leading-relaxed max-w-[90%]">
                    Iniciar sesión de escaneo o ver historial.
                </p>
            </div>
        </button>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* TARJETA 2: CONSOLIDADOS ERP */}
            <button 
            ...
            {/* TARJETA 3: DETECTIVE / CONCILIADOR */}
            <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* TARJETA 4: DATOS MAESTROS - UPDATED TO CYAN/BLUE GRADIENT */}
            <button 
            ...
            {/* TARJETA 5: AJUSTES - UPDATED TO SLATE/ZINC GRADIENT */}
            <button 
