...
import {
  ...
  validateYearInput,
  validateMonthInput,
} from '../hooks/useExpiryValidation';
import { MESES, AÑOS, useKeyboardDateDetection } from './ExpiryCaptureModal/expiryCaptureConstants';
      ...
      if (isEditMode && initialData) {
        ...
        const fetchProduct = async () => {
          try {
            ...
            // Buscar en productos
            let foundProduct = await db.products
              .where('barcode')
            ...
            if (!foundProduct) {
              foundProduct = await db.products
                .where('sku')
                .equalsIgnoreCase(normalizedCode)
                .first();
            }
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`font-black text-sm truncate max-w-[200px] ${
              ...
              <div className="flex items-center gap-2">
                ...
                {barcode.length >= 8 && (
                  <div
                    className={`px-2 py-1.5 rounded-xl border-2 text-[10px] font-black uppercase tracking-tighter flex items-center gap-1 ${
                      productFound
                ...
                {product && (
                  <div
                    className={`px-3 py-1.5 rounded-xl border-2 text-[10px] font-black uppercase tracking-tighter flex flex-col items-center leading-none ${
                      hasCanje
                ...
                {product?.supplierName && (
                  <div
                    className={`px-3 py-1.5 rounded-xl border-2 text-[10px] font-black uppercase tracking-tighter ${
                      isDark
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar">
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="w-5 h-5 rounded-lg bg-blue-500/20 text-blue-500 flex items-center justify-center text-[10px] font-black">
                    3
                  </span>
                  Seleccione Mes{' '}
                  {selectedMm && <span className="text-blue-400">→ {MESES[selectedMm - 1]}</span>}
                </label>
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="w-5 h-5 rounded-lg bg-emerald-500/20 text-emerald-500 flex items-center justify-center text-[10px] font-black">
                    4
                  </span>
                  Seleccione Año{' '}
                  {selectedYyyy && <span className="text-emerald-400">→ {selectedYyyy}</span>}
                </label>
                <div className="grid grid-cols-4 gap-2">
                  {AÑOS.map(y => (
                    <button
              ...
              {selectedMm &&
                ...
                (() => {
                  ...
                  const withdrawalDateCalc = new Date(
                    expiryDate.getTime() - withdrawalDays * 24 * 60 * 60 * 1000
                  );
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          >
                            {withdrawalMonth} {withdrawalDateCalc.getDate()},{' '}
                            {withdrawalDateCalc.getFullYear()}
                          </p>
                        </div>
              ...
              {isEditMode && (
                <div className="space-y-3">
                  ...
                  >
                    <span className="w-5 h-5 rounded-lg bg-purple-500/20 text-purple-500 flex items-center justify-center text-[10px] font-black">
                      !
                    </span>
                  ...
                  >
                    ...
                    <div>
                      <label
                        className={`text-xs font-bold mb-2 block ${isDark ? 'text-white' : 'text-slate-900'}`}
                      >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        />
                        <span
                          className={`w-16 text-center font-black text-lg ${
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {validation.errors.map((error, i) => (
                        <p key={i} className="text-[10px] opacity-90">
                          {error}
                        </p>
                      ))}
                    </div>
...
// useKeyboardDateDetection ahora se importa de ./ExpiryCaptureModal/expiryCaptureConstants
