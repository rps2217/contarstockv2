...
export const ProductCard: React.FC<ProductCardProps> = memo(({
  ...
  const stockStatus = product.stock !== undefined && product.minStock !== undefined
      ...
      <div className="p-4 flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            {stockStatus && (
              <span className={cn('text-xs font-medium px-2 py-0.5 rounded-full', statusBg[stockStatus], statusColors[stockStatus])}>
                {stockStatus === 'out' ? 'Sin stock' : stockStatus === 'low' ? 'Bajo stock' : 'OK'}
              </span>
            )}
          </div>
...
export const SupplierCard: React.FC<SupplierCardProps> = memo(({
  ...
  const syncStatusColor = supplier.syncStatus === 'synced' ? 'text-emerald-500' : 
                          supplier.syncStatus === 'pending' ? 'text-amber-500' : 'text-rose-500';
